...
window.onload=function (){
    ...
    const config = {
        ...
        scene: [Preloader,MenuSceneWS,HostOrJoin,OnlineCoop1,OnlineCoop2,OnlineCoop3,OnlineComp1,OnlineComp2,OnlineComp3,OnlineGameCompletedScene,JoinScreen,CharacterTestScene, Coop1,Coop2,Coop3, GameCompletedScene, Comp1, Comp2, Comp3, Credits,Tutorial],
