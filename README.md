...
pasa a solicitar los mensajes anteiores mandando un mensaje "anzuelo" al servidor, el cual propicia que se envíen todos
...
parseandolos y transformandolos a datos que puedan ser imprimidos por pantalla.

En cuanto al envío de mensajes, una vez que el usuario envía un mensaje dandole al botón Send, el programa recoge y envía el mensaje 
al servidor, este es recibido y clasificado de acuerdo a un tipo interno genérico, el cual le dice que es un mensaje de chat común
y lo almacena en el historial de mensajes. Una vez almacenado, lo envía a todos los usuarios conectaods al chat.
Al enviarse, se activa el eventListener activado anterioremente y lo transforma en datos que a continuación son impresos por pantalla.
...
al servidor una actualización de los mensajes, ya fuera la respuesta dada por el sevidor positiva (hay mensajes nuevos) o negativa (no hay mensajes nuevos).
